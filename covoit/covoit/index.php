...
<header class="masthead">
    <div class="container">
        <div class="masthead-subheading">Les Briques Rouges covoiturage</div>
        <div class="masthead-heading text-uppercase">Allez aux festivals ensembles!</div>
        <a class="btn btn-danger btn-lg text-uppercase" style="background-color: #AF001E;" href="#services">Rejoindre un voyage</a>
    </div>
</header>
...
<section class="page-section" id="services">
    <div class="container">
        <div class="text-center">
            <h2 class="section-heading text-uppercase">Fonctionnement</h2>
            <h3 class="section-subheading text-muted">Rejoindre un trajet</h3>
        </div>
        <div class="row text-center">
            <div class="col-md-4">
                ...
                <h4 class="my-3"style="color: #FFFEE6">Recherchez cliqués et réservez</h4>
                </br>
                <p class="" style="color: #D2D1BF">Visualisez les trajets disponibles sur la carte. Cliquez pour selectionner le trajet qui vous correspond, puis faites une demande au festivalier proposant le trajet. Vous recevrai un e-mail une fois votre demande accepté.</p>
            </div>
            <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-danger"></i>
                ...
                <h4 class="my-3" style="color: #FFFEE6">Trouvez un trajet qui vous correspond</h4>
                <p class="" style="color: #D2D1BF">Vous trouverez le trajet idéal parmis un large choix de trajets, proposés par nos festivalier, vous pouvez également faire des demandes de trajets près de chez-vous. Retrouvez tous vos demande de trajet dans l'onglet 'mes trajets'</p>
            </div>
            <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-danger"></i>
                ...
                <h4 class="my-3" style="color: #FFFEE6">Voyagez en bonne companie</h4>
                </br>
                <p class="" style="color: #D2D1BF">Partagez le trajet ves nos festivales où vers chez vous, dans la bonne ambiance,  en compagnie d'autres festivaliers.</p>
            </div>
        </div>
    </div>
</section>
